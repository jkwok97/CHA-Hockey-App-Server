...
const getGoalieStatsByPlayerId = (req, res, knex) => {
    knex.select(
        'a.*',
        'b.firstname',
        'b.lastname',
...
const getGoalieStatsbyType = (req, res, knex) => {
    knex.select(
        'a.*',
        'b.firstname',
        'b.lastname',
...
const getGoalieStatsByTypeSummed = (req, res, knex) => {
    knex.raw(`
        select
        b.firstname as firstname,
        b.lastname as lastname,
...
module.exports = {
    getGoaliesStats, getGoaliesStatsById, getGoalieStatsByPlayerId, getActiveGoaliesByTeam, 
    getGoaliesBySeasonByType,
    getGoalieStatsbyType, getGoalieStatsByTypeSummed,
    ...
    updateGoaliesStatsById, getFreeAgents
};