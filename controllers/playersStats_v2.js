...
getPlayersByShowByTypeByUser = (req, res, knex) => {
    ...
    knex.select(
        ...
        'a.season_type',
        'a.team_name',
        'a.games_played.sum(a.games_played) as games_played',
        'a.goals.sum(a.goals) as goals',
        'a.assists.sum(a.assists) as assists',
        'a.points.sum(a.points) as points',
        'a.plus_minus.sum(a.plus_minus) as plus_minus',
        'a.penalty_minutes.sum(a.penalty_minutes) as penalty_minutes',
        'a.sh_goals.sum(a.sh_goals) as sh_goals',
        'a.pp_goals.sum(a.pp_goals) as pp_goals',
        'a.gw_goals.sum(a.gw_goals) as gw_goals',
        'a.gt_goals.sum(a.gt_goals) as gt_goals',
        'a.shots.sum(a.shots) as shots',
        'a.minutes_played.sum(a.minutes_played) as minutes_played',
        'a.hits.sum(a.hits) as hits',
        'a.blocked_shots.sum(a.blocked_shots) as blocked_shots'
        )
        .from('players_stats_v2 as a')
        .leftJoin('players_v2 as b', 'b.id', 'a.player_id')
        .leftJoin('teams_v2 as c', 'c.shortname', 'a.team_name')
