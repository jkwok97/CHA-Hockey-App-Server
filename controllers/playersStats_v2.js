...
getPlayersByShowByTypeByUser = (req, res, knex) => {
    ...
    knex.select(
        ...
        'a.season_type',
        'a.team_name',
        'players_stats_v2.sum(a.games_played) as games_played',
        'players_stats_v2.sum(a.goals) as goals',
        'players_stats_v2.sum(a.assists) as assists',
        'players_stats_v2.sum(a.points) as points',
        'players_stats_v2.sum(a.plus_minus) as plus_minus',
        'players_stats_v2.sum(a.penalty_minutes) as penalty_minutes',
        'players_stats_v2.sum(a.sh_goals) as sh_goals',
        'players_stats_v2.sum(a.pp_goals) as pp_goals',
        'players_stats_v2.sum(a.gw_goals) as gw_goals',
        'players_stats_v2.sum(a.gt_goals) as gt_goals',
        'players_stats_v2.sum(a.shots) as shots',
        'players_stats_v2.sum(a.minutes_played) as minutes_played',
        'players_stats_v2.sum(a.hits) as hits',
        'players_stats_v2.sum(a.blocked_shots) as blocked_shots'
        )
        .from('players_stats_v2 as a')
        .leftJoin('players_v2 as b', 'b.id', 'a.player_id')
        .leftJoin('teams_v2 as c', 'c.shortname', 'a.team_name')
