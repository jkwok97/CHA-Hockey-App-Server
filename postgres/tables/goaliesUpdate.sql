...
FROM   tmp_x
WHERE  goalie_stats.player_id = tmp_x.player_id AND goalie_stats.playing_year = tmp_x.playing_year AND goalie_stats.season_type = tmp_x.season_type;
