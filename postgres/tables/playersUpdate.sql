...
FROM   tmp_x
WHERE  players_stats.player_id = tmp_x.player_id AND players_stats.playing_year = tmp_x.playing_year AND players_stats.season_type = tmp_x.season_type;
